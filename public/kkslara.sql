...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 02, 2025 at 02:26 PM
...
CREATE TABLE `info_goal` (
  ...
  `goal_sub` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `location_cities` (
  ...
  `city_url` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `location_districts` (
  ...
  `district_url` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `location_localites` (
  ...
  `district_id` smallint NOT NULL,
  `locality_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `locality_url` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `locality_lat` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `locality_long` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `location_states` (
  ...
  `state_url` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
('8rZbEBGAtVPsDsbOTr2BwIbRMuXJekuT2fhw628Z', NULL, '::1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/135.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiMGZLNzlVUzNUdzQ2U0lRMm1ZcU9UUFFHNUxxR3VRV1d1TzJpNHZJcyI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjQ6Imh0dHA6Ly9sb2NhbGhvc3Qva2tjbGFyYSI7fX0=', 1751456587);
...
(1, 'Pinkesh Kumar', 'pinkeshku@gmail.com', NULL, '$2y$12$2to9ezuQsYDVXTE0Gy1.pue2K1Q4iGqYJihSVR9g26aNF/UHYogb2', NULL, '2025-07-01 03:44:22', '2025-07-01 03:44:22'),
(2, 'Pinkesh Kumar', 'pinkeshku1@gmail.com', NULL, '$2y$12$.WEjnDsDtIUTIPtwjPHqdeP32xiAxBx7AKkP6D3ZYbiR.UB2KBXfe', NULL, '2025-07-02 01:18:53', '2025-07-02 01:18:53');

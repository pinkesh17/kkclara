	...
	<section>
		<div class="page-header">
			<div class="header-inner">
				<h4 class="text-white">To unlock full access, please complete at least 60% of your profile.</h4>
				<p>
									...
									<div class="widget">
										...
										<div class="pit-reg-complete">
											<div class="progresdiv"  data-percent="60">
												  ...
												  <circle r="50" cx="50" cy="50" fill="transparent" stroke-dasharray="314.16" stroke-dashoffset="0" ></circle>
												  <circle class="bar" r="50" cx="50" cy="50" fill="transparent" stroke-dasharray="314.16" stroke-dashoffset="0"></circle>
												</svg>
											</div>
											<div class="reg-comp-meta">
												...
												<ul>
													...
													<li><i class="fa-regular fa-envelope bg-red"></i> <span>Complete Registration 20%</span> 
													...
													<li><i class="fa-regular fa-envelope bg-red"></i> <span>Update Address  20%</span> 
														<a href="{{url('dashboard/profile-information')}}" title="" class="underline">Add</a>
													</li>
													...
													<li><i class="fa-regular fa-map-marker bg-green"></i> <span>Very by admin 30%</span>
														<a href="#" title="" class="underline">Add</a>
													</li>
												</ul>
											</div>

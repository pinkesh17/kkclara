				              ...
				              <div class="tabs-box">
				                ...
				                <div class="widget-content">
				                  ...
				                  <form class="form-main" autocomplete="off">
				                  	 @csrf
				                  	 @method('PUT')
				                  	 <input type="hidden" id="id" name="{{Auth::user()->id}}">


				                    <div class="row">

				                    <div class="form-group col-lg-2 col-md-12">
				                        <label for="pefix">Prefix</label>
										<select class="mb-2" id="pefix">
				                      ...
				                      <div class="form-group col-lg-6 col-md-12">
				                        ...
				                        <input type="text" id="date_of_birth" name="date_of_birth" class="date-input" value="{{Auth::user()->date_of_birth}}">
				                      </div>
				                      ...
				                      <div class="col-lg-6 col-md-12 col-sm-12">
											<div class="gender mb-2">
												...
												<div class="form-radio">
												  <div class="radio">
													<label>
													  <input type="radio" name="radio" value="1"><i class="check-box"></i>Male
													</label>
												  </div>
												  <div class="radio">
													<label>
													  <input type="radio" name="radio" value="2"><i class="check-box"></i>Female
													</label>
												  </div>
												</div>
											</div>

<div class="topbar stick">
		...
		<div class="top-area">
					...
					<div class="dropdowns">
						...
						<ul class="drops-menu">
							<li>
								<div>
									<figure>
										<img src="{{asset('dashboard/images/resources/thumb-2.jpg')}}" alt="">
									</figure>
									<div class="mesg-meta">
							...
							<li>
								<div>
									<figure>
										<img src="{{asset('dashboard/images/resources/thumb-3.jpg')}}" alt="">
									</figure>
									<div class="mesg-meta">
							...
							<li>
								<div>
									<figure>
										<img src="{{asset('dashboard/images/resources/thumb-4.jpg')}}" alt="">
									</figure>
									<div class="mesg-meta">
							...
							<li>
								<div>
									<figure>
										<img src="{{asset('dashboard/images/resources/thumb-5.jpg')}}" alt="">
									</figure>
									<div class="mesg-meta">
							...
							<li>
								<div>
									<figure>
										<img src="{{asset('dashboard/images/resources/thumb-1.jpg')}}" alt="">
									</figure>
									<div class="mesg-meta">
			...
			<div class="user-img">
				<h5>Jack Carter</h5>
				<img src="{{asset('dashboard/images/resources/admin.jpg')}}" alt="">
				<span class="status f-online"></span>

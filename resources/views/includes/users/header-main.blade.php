        ...
        <div class="col-auto px-0">
          <div class="d-flex align-items-center justify-content-between">
            <div class="logos br-white-light pr30 pr5-xl">
              <a class="header-logo logo1" href="{{url('')}}"><img src="{{asset('assets/images/header-logo.svg')}}" alt="Header Logo"></a>
              <a class="header-logo logo2" href="{{url('')}}"><img src="{{asset('assets/images/header-logo2.svg')}}" alt="Header Logo"></a>
            </div>

                        ...
                        <div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="md:flex items-center gap-10">
                                  ...
                                  <div class="md:flex items-center gap-10">
                                    <label for="date_of_birth" class="md:w-32 text-right"> Date of Birth </label>
                                    <div class="flex-1 max-md:mt-4">
                                        <input id="date_of_birth" datepicker datepicker-buttons datepicker-autoselect-today type="text" datepicker-max-date="{{Carbon\Carbon::now()->format('d-m-Y')}}" datepicker-orientation="top" datepicker-format="dd-mm-yyyy" class="lg:w-1/2 w-full" placeholder="Select date" id="date_of_birth" name="date_of_birth">
                                    </div>
                                </div>    

                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="welcome-img text-center text-sm-end mt-4 mt-sm-0">
                                <img src="{{asset('admin/assets/images/welcome.png')}}" alt="welcome">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <ul class="ps-0 mb-0 list-unstyled sales_by_locations mt-4">
                        <li class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{asset('admin/assets/images/usa.svg')}}" class="wh-30 rounded-circle" alt="usa">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{asset('admin/assets/images/germany.svg')}}" class="wh-30 rounded-circle" alt="germany">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{asset('admin/assets/images/united-kingdom.svg')}}" class="wh-30 rounded-circle" alt="united-kingdom">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{asset('admin/assets/images/canada.svg')}}" class="wh-30 rounded-circle" alt="canada">
                            </div>
                            <div class="flex-grow-1 ms-3">
                            ...
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href="product-details.html" class="d-flex align-items-center">
                                                <img src="{{asset('admin/assets/images/product-1.jpg')}}" class="wh-40 rounded-3" alt="product-1">
                                                <div class="ms-2 ps-1">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="product-details.html" class="d-flex align-items-center">
                                                <img src="{{asset('admin/assets/images/product-2.jpg')}}" class="wh-40 rounded-3" alt="product-2">
                                                <div class="ms-2 ps-1">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="product-details.html" class="d-flex align-items-center">
                                                <img src="{{asset('admin/assets/images/product-3.jpg')}}" class="wh-40 rounded-3" alt="product-3">
                                                <div class="ms-2 ps-1">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="product-details.html" class="d-flex align-items-center">
                                                <img src="{{asset('admin/assets/images/product-4.jpg')}}" class="wh-40 rounded-3" alt="product-4">
                                                <div class="ms-2 ps-1">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="product-details.html" class="d-flex align-items-center">
                                                <img src="{{asset('admin/assets/images/product-5.jpg')}}" class="wh-40 rounded-3" alt="product-5">
                                                <div class="ms-2 ps-1">
                            ...
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="my-profile.html" class="d-flex align-items-center">
                                                <img src="{{asset('admin/assets/images/user-1.jpg')}}" class="wh-40 rounded-3" alt="user">
                                                <div class="ms-2 ps-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="my-profile.html" class="d-flex align-items-center">
                                                <img src="{{asset('admin/assets/images/user-2.jpg')}}" class="wh-40 rounded-3" alt="user">
                                                <div class="ms-2 ps-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="my-profile.html" class="d-flex align-items-center">
                                                <img src="{{asset('admin/assets/images/user-3.jpg')}}" class="wh-40 rounded-3" alt="user">
                                                <div class="ms-2 ps-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="my-profile.html" class="d-flex align-items-center">
                                                <img src="{{asset('admin/assets/images/user-4.jpg')}}" class="wh-40 rounded-3" alt="user">
                                                <div class="ms-2 ps-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="my-profile.html" class="d-flex align-items-center">
                                                <img src="{{asset('admin/assets/images/user-5.jpg')}}" class="wh-40 rounded-3" alt="user">
                                                <div class="ms-2 ps-1">
